...
const surveyQuestions = [
  ...
  {
    id: 'skip',
    label: 'Which part would you skip if you were using this with your team?',
    options: [
      'The weekly goal',
      'The daily thing',
      'The bonus row',
      'The ships trail',
      "Honestly, I'd use all of it",
    ],
  },
  {
    id: 'lost',
    label: 'Where did the demo lose you?',
    options: [
      'Onboarding',
      "I wasn't sure what to type",
      'The layout',
      'Nothing — I got it',
  ...
  {
    id: 'replace',
    label: 'What would your team replace with Zanshin?',
    options: [
      'A Slack thread',
      'Geekbot, Range, or another standup tool',
      'A live standup meeting',
      "Nothing — we don't do standups",
    ],
  },
];

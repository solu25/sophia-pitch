...
- Built pitch-app portfolio at `/Users/sophia/Documents/Claude/sophia/pitch-app/`
...
- sophia.js has full story + screen references for: myperks, roadrunner, megprime, navigation, curbside, arenalabs
...
- Added `leadgen` case study to `sophia.js` — the lead-gen tool (scrapes YC/Reddit/HN/LinkedIn, scores leads, drafts outreach)
- No screens added for leadgen yet (skip images for now)

## Current state of sophia.js projects
| ID | Company | Screens |
|----|---------|---------|
